...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		...
		//性能监控
		filterChainDefinitionMap.put("/actuator/metrics/**", "perms[actuator:view]");
		filterChainDefinitionMap.put("/actuator/httptrace/**", "perms[actuator:view]");
		filterChainDefinitionMap.put("/actuator/redis/**", "perms[actuator:view]");
